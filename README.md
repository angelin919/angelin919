...
### 📁 Проекты
[🔗 Перейти к проекту DemoWebShop](projects/MobileTesting/TodoApp)
- 📊 Чек-листы, тест-кейсы, баг-репорты, Postman коллекция

### 📱 [Мобильное тестирование — примеры проектов](projects/MobileTesting/README.md)
- ✅ Todo App: функциональное тестирование, чек-лист
